package com.bank.bian.bankdrafts.model;
...
/**
 * The BIAN control record for this service domain: "Bank Draft Fulfillment Arrangement".
 *
 ...
 * to its asset type (Bank Draft). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Bank Draft Fulfillment Arrangement";
